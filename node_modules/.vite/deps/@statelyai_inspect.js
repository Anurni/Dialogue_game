  ...
  "node_modules/@statelyai/inspect/dist/index.js"(exports, module) {
    ...
    function createInspector(adapter, options) {
      function sendAdapter(event) {
        var _a2;
        if ((options == null ? void 0 : options.filter) && !options.filter(event)) {
          return;
        }
        const serializedEvent = ((_a2 = options == null ? void 0 : options.serialize) == null ? void 0 : _a2.call(options, event)) ?? event;
